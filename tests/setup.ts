...
// Always use a valid test secret (the shell/env may have a short dev placeholder).
// IMPORTANT: this value must be >= 32 chars to satisfy env.ts validation.
...
// USDC issuer addresses required by env.ts schema (#769 fix)
